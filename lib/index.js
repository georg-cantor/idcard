(function() {
  ...
  function generateIdcard(objParam) {
    ...
    let birthday = _randomBirthday();
    //todo objParam, only birthday is needed currently
    if (objParam.birthday != undefined) {
      birthday = objParam.birthday;
    }

    var pre17Char = "" + _randomAreaCode() + birthday + _randomLocalPolice() + _randomSex();
